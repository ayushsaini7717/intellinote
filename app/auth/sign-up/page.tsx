      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-balance text-sm text-muted-foreground">AI-powered knowledge management</p>
          </div>
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Sign up</CardTitle>
              <CardDescription>Create your account to start taking intelligent notes</CardDescription>
            </CardHeader>
            <CardContent>
